...
fn run(gpa: Allocator, io: Io, input: []const u8) !usize {
    ...
    mem.sortUnstable(Circuit, circuits.items, {}, circuitOrder);
...
fn circuitOrder(_: void, a: Circuit, b: Circuit) bool {
